...
import { spacing, setSpacing } from "./themeUtils";
...
describe("theme tests", () => {
  describe.concurrent("spacing", () => {
    ...
    it.concurrent.each([
      ...
      [2, "16px"],
      [4, "32px"],
    ])("should return the correct result with 1 argument, arg: %d", (arg, expected) => {
    ...
    it.concurrent.each([
      ...
      [1, 0, "8px 0px"],
      [0, 2, "0px 16px"],
    ])("should return the correct result with 2 arguments, args: %d, %d", (a1, a2, expected) => {
    ...
    ])("should return the correct result with 4 arguments, args: %d, %d, %d, %d", (a1, a2, a3, a4, expected) => {
